graph TD
    ...
    subgraph "Zone 2: User/IoT Networks"
    ...
    subgraph "Zone 3: Service Networks"
    ...
    subgraph "Zone 4: Kubernetes Infrastructure"
    ...
    class "Zone 1: Core Infrastructure","Zone 2: User/IoT Networks","Zone 3: Service Networks","Zone 4: Kubernetes Infrastructure" zone
